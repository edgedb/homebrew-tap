class EdgedbCliNightly < Formula
  ...
  on_linux do
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      ...
      url "https://packages.edgedb.com/archive/x86_64-unknown-linux-musl.nightly/edgedb-cli-3.0.0-dev.947+0988957?edgedb.nightly",
        using: :nounzip
      sha256 "6a0a4704b1810f69cceee59bdee541f6c816f7ba3c6ac38738ecf47f4a725990"
    else
      odie "Unsupported CPU architecture!"
    end
  end
