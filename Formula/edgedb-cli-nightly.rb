class EdgedbCliNightly < Formula
  ...
  on_macos do
    if Hardware::CPU.physical_cpu_arm64?
      ...
      url "https://packages.edgedb.com/archive/x86_64-apple-darwin.nightly/edgedb-cli-3.0.0-dev.979+35bf4f4?edgedb.nightly",
        using: :nounzip
  ...
  on_linux do
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://packages.edgedb.com/archive/aarch64-unknown-linux-musl.nightly/edgedb-cli-3.0.0-dev.979+131588b?edgedb.nightly",
        using: :nounzip
